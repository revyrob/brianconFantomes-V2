...
function Credits() {
  ...
  return (
    <section
      id="credits"
      className="p-4 h-[300px] relative truncate text-center"
    >
      ...
      <div className=" w-full justify-center truncate whitespace-normal">
        <div className="animate-marquee-infinite relative ">
          <h2 className="text-lg ">{dictionary.heading1}</h2>
