        ...
        <Toolbar disableGutters>
          ...
          <a href="#tour">
            ...
            >
              <button
                type="button"
                className=" border-solid border-white border-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-2 py-2 text-center mx-4 md: dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
              >
                {dictionary.button}
              </button>
            </Box>
